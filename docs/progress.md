...
#### D03（主進程骨架）
- [ ] P1-W01-D03-BOOT-MainEntry-T01 建立 src/main/index.ts 設定 BrowserWindow（min 1024x768 標題）；驗收：npm run dev 啟動視窗尺寸正確。
...
#### D05（渲染層起步）
- [ ] P1-W01-D05-UI-RendererBootstrap-T01 建立 src/renderer/main.tsx、App.tsx，渲染占位頁；驗收：npm run dev 顯示 React 佈局。
